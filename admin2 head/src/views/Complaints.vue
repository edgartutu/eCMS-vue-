       ...
       <v-layout row wrap :class="`pa-3 project ${project.status}`">
         ...
         <v-flex xs2 sm4 md1>
           <router-link   :to="{ name: 'Stepperview',
            ...
            complaint_detail:project.complaint,levels:project.level,post:project.post,picto:project.picture,description:project.complaint,time:project.due} } }" >
				    <v-btn
...
export default{
  ...
  data(){
    ...
    // },
      ...
      projects:[
        {title:'Ec-2342-2019-041',person:'Walugembe John',due:'9/feb/2019',status:'Unresolved',content:'miss use of property',
        ...
        {title:'Clone a new web',person:'jack',due:'6/march/2019',status:'Unresolved',content:'miss use of property',
        phone:'0700418430',complaint:'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi officiis, tempora suscipit amet ullam eligendi repellendus quaerat quasi quam aperiam, ut architecto veritatis. Provident, aliquid similique placeat ullam sit quod?',
        level:"Staff",Location:'Hoima',post:'supervisor',picture:'zzzzzzz'},
        {title:'Art a new web',person:'shot',due:'4/april/2019',status:'Unresolved',content:'miss use of property',
        phone:'0700418430',complaint:'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi officiis, tempora suscipit amet ullam eligendi repellendus quaerat quasi quam aperiam, ut architecto veritatis. Provident, aliquid similique placeat ullam sit quod?',
        level:"Staff",Location:'Hoima',post:'supervisor',picture:'zzzzzzz'},
